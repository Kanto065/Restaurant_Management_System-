        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    MaxMileage = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveredToPos = table.Column<bool>(type: "boolean", nullable: false),
                    DeliveredToAdmin = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    RestaurantId = table.Column<Guid>(type: "uuid", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpgradeModifierGroupId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    RestaurantId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealComponents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DealComponents_Deals_DealId",
                        column: x => x.DealId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThemeColorPrimary = table.Column<string>(type: "text", nullable: false),
                    ThemeColorSecondary = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "text", nullable: true),
                    FullName = table.Column<string>(type: "text", nullable: false),
                    LoyaltyPointsBalance = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    RestaurantId = table.Column<Guid>(type: "uuid", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceSecretHash = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TlsProvisioned = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Domains_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "MenuCategoryAvailableDays",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuCategoryAvailableDays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuCategoryAvailableDays_MenuCategories_MenuCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllergenTagsJson = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    RestaurantId = table.Column<Guid>(type: "uuid", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    RawEventLogJson = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    RestaurantId = table.Column<Guid>(type: "uuid", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameSnapshot = table.Column<string>(type: "text", nullable: false),
                    PriceDeltaSnapshot = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    RestaurantId = table.Column<Guid>(type: "uuid", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerAddresses_RestaurantId",
                table: "CustomerAddresses",
                column: "RestaurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DealComponents_DealId",
                table: "DealComponents",
                column: "DealId");

            migrationBuilder.CreateIndex(
                name: "IX_DealComponents_RestaurantId",
                table: "DealComponents",
                column: "RestaurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuCategoryAvailableDays_MenuCategoryId",
                table: "MenuCategoryAvailableDays",
                column: "MenuCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuCategoryAvailableDays_RestaurantId",
                table: "MenuCategoryAvailableDays",
                column: "RestaurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemModifierGroups_RestaurantId",
                table: "MenuItemModifierGroups",
                column: "RestaurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModifierOptions_RestaurantId",
                table: "ModifierOptions",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationEvents_RestaurantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemModifiers_RestaurantId",
                table: "OrderItemModifiers",
                column: "RestaurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatusHistories_RestaurantId",
                table: "OrderStatusHistories",
                column: "RestaurantId");
